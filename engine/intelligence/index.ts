...
export {
  ...
  type RetrievalInspectionRecord,
...
export {
  ...
  type ConflictDetectorKind,
  type ConflictConfidence,
  type ExtractedRuleStatus,
  type ConflictRule,
  type ExtractedConflictRule,
  type ContextConflictFinding,
  type ContextConflictScanResult,
  type ConflictIgnoreEntry,
